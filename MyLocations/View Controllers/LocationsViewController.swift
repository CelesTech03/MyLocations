...
//  MyLocations
//
//  Created by Celeste Urena on 10/27/22.
//
...
class LocationsViewController: UITableViewController {
    ...
    // Create fetch request to retrieve object that I previously saved to the data store
    lazy var fetchedResultsController: NSFetchedResultsController<Location> = {
        ...
        // Sorts Location objects by category and and inside each of the category groups, sort by date
    ...
    // Sets the delegate to nil when it no longer needs the NSFetchedResultsController
    deinit {
